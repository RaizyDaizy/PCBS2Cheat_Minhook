...
uintptr_t unlockedpcbay = 0xB39BC0; //Address of Unlocked PC Bay :D
uintptr_t addcash = 0xB2B830; //AddCash :D
uintptr_t CollectCash_addr = 0xB2ECE0;
uintptr_t setbusname_address = 0xB386F0;
uintptr_t updatebusinessname_address = 0xB39C00;
void CreateConsole() 
{
    AllocConsole();
    FILE* fp;
...
bool __stdcall UnlockedPCBay_hack(DWORD* __this, DWORD* method) 
{
    ...
    return UnlockedPCBay_o(__this, method);
}
...
void __stdcall SetBusinessName_h(DWORD* __this, LPCSTR name, DWORD* method)
{
    name = "ZA WARUDO!!!";
